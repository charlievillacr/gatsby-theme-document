---
title: 'B. Where to Insert JavaScript'
...
In this example, a JavaScript `function` is placed in the `<body>` section of and HTML page.
...
The script will behave as if it was located exactly where th `<script>`

External scripts cannot contain `<script>` tags.

## External JavaScript Advantages

Placing script in external files has some advantages:
